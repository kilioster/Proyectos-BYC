...
class inventarioAdm(admin.ModelAdmin):
    ...
    search_fields = ["empresa", "responsable", "cargo", "area"]
...
class planesAdm(admin.ModelAdmin):
    list_display = ["nombre", "numero", "company"]
    search_fields = ["nombre", "company"]
    sortable_by = ("nombre", "company")
    
    actions = [download_excel]

admin.site.register(Planes, planesAdm)